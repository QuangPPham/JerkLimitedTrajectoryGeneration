...
# axs[0,0].plot(t_interp1, p_interp1[0,:], 'o-', c="b", ms=7.5, label="Interpolation points")
...
# axs[0,2].plot(t_interp1, s_interp1, 'o-', c="b", ms=7.5, label="Interpolation points")
axs[0,2].plot(t_sampling, s_sampling, 'o-', c="g", ms=5, label="Sampling points")
# axs[0,2].plot(t_ana, s_ana, '-', lw=3, c="r", label="Analytical path")
...
# axs[1,2].plot(t_ana, v_ana, '-', lw=3, c="r", label="Analytical path")
...
# axs[2,2].plot(t_ana, np.abs(a_ana), '-', lw=3, c="r", label="Analytical path")

# jerks
idx_j = sj_sampling < J*1.1 # range(len(s_sampling))
...
# axs[3,2].plot(t_ana, np.abs(j_ana), '-', lw=3, c="r", label="Analytical path")
